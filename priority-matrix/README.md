...
| Q1 重要且紧急 | 高考志愿填报 | 陕西省高考志愿业务仍处于 6.25 前关键转化窗口；但详细业务运营和任务清单已经迁移到 `Business-Unit-for-Gaokao/gaokao`。 | 本仓库只保留 Q1 判断和本周摘要：直播、推荐家长、重点客户档案、6999 话术、网站/小程序承接、联络西安外地招生办；专项执行看 `BUSINESS_OPERATING_PLAN.md` 和 `GAOKAO_VOLUNTEER_TASKS.md`。 |
