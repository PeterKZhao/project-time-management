...
| 蓝鹦鹉在线教育 | 测试 | 赵杨 | iOS 发布和 Apple Pay 系统测试阻塞；下一步让 Codex 做自动化测试。 |
| AI 中转站做视频生成 | 已搭建 | 赵凯、赵杨 | 围绕 AI 中转站能力承接视频生成需求，先整理产品入口、调用链路和演示场景。 |
| 视频生成 | 规划中 | 赵凯、赵杨 | 视频 AI 工具链和业务单元整理。 |
| 量化交易 | 规划中 | 赵凯、赵杨 | 股票智能分析、量化、资讯和回测工具链。 |
