...
| 蓝鹦鹉在线教育 | 测试 | 赵杨 | UniApp | RuoYi-Vue-Pro / Spring Boot | [Business-Unit-for-Lingsure](https://github.com/Business-Unit-for-Lingsure) | iOS 发布和 Apple Pay 系统测试阻塞；下一步让 Codex 做自动化测试。 |
| AI 中转站做视频生成 | 已搭建 | 赵凯、赵杨 | 待定 | AI 中转站 / API 聚合 | [Business-Unit-for-Station](https://github.com/Business-Unit-for-Station) | 围绕 AI 中转站能力承接视频生成需求，先整理产品入口、调用链路和演示场景。 |
| 视频生成 | 规划中 | 赵凯、赵杨 | 待定 | AI 视频工具链 / API 聚合 | [Business-Unit-for-Video](https://github.com/Business-Unit-for-Video) | 视频 AI 工具链和业务单元整理。 |
| 量化交易 | 规划中 | 赵凯、赵杨 | Gin-Vue-Admin / Vue | Gin / Go | [Business-Unit-for-Stock](https://github.com/Business-Unit-for-Stock) | 股票智能分析、量化、资讯和回测工具链。 |
